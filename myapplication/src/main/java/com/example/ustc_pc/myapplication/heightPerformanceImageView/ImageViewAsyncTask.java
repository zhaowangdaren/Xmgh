 ...
 */
public abstract class ImageViewAsyncTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link ImageViewAsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link ImageViewAsyncTask.Status#RUNNING} or {@link ImageViewAsyncTask.Status#FINISHED}.
     *
     * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
     * @see #execute(Runnable)
     */
    public final ImageViewAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final ImageViewAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final ImageViewAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(ImageViewAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
